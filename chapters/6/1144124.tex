...
\lstinputlisting[caption = Kode program untuk fungsi Bar Plot dengan menggunakan Matplotlib., firstline=1, lastline=21]{src/6/1144124/1144124_bar.py}
...
\lstinputlisting[caption = Kode program fungsi Scatter Plot dengan menggunakan Matplotlib., firstline=1, lastline=23]{src/6/1144124/1144124_scatter.py}
...
\lstinputlisting[caption = Kode program untuk fungsi Pie Plot dengan menggunakan Matplotlib., firstline=1, lastline=23]{src/6/1144124/1144124_pie.py}
...
\lstinputlisting[caption = Kode program untuk fungsi Plot dengan menggunakan Matplotlib., firstline=1, lastline=23]{src/6/1144124/1144124_plot.py}
...
\end{itemize}
\lstinputlisting[caption = Kode program untuk fungsi penanganan error., firstline=1, lastline=18]{src/6/1144124/error.py}
