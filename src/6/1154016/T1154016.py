# -*- coding: utf-8 -*-
"""
Created on Tue Apr  8 23:45:03 2019
...
#makan =[7,8,6,8,7,9,10]
#tidur = [2,3,4,3,2,3,4]
#belajar =[7,8,7,2,2,6,0]
#olahraga = [8,5,7,8,13,15,25]
...
#plt.stackplot(poe, makan,tidur,belajar,olahraga, colors=['m','c','r','k'])
...
makan =[7,8,6,11,7,8,9]
tidur = [2,3,4,3,2,7,5]
belajar =[7,8,7,2,2,4,2]
olahraga = [8,5,7,8,13,7,15]
slices = [7,2,2,13]
activities = ['makan','tidur','belajar','olahraga']
cols = ['c','m','r','b']
