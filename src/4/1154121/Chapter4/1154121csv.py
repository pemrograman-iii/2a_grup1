...
def tulisCsv():
    with open('teori6.csv', mode='w') as csv_file:
        ...
        writer.writeheader()
        writer.writerow({'npm': '1164124', 'nama': 'Felix', 'kelas': 'D4TI3A', 'tanggal lahir': '05/06/1997'})
        writer.writerow({'npm': '1164103', 'nama': 'Niko', 'kelas': 'D4TI3C', 'tanggal lahir': '07/05/1996'})
